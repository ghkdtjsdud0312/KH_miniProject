...
public class CustomerDAO {
    ...
    public static void customerInsert() throws Exception {
        ...
        while (true) {
            ...
            String sql = "INSERT INTO CUSTOMER_INFO(USER_ID,USER_PW,USER_NAME,GENDER,PHONE,ADDR,BIRTH,EMAIL,MONTHFEE) "
                    + "VALUES(?,?,?,?,?,?,?,?,?)";
    ...
    private static boolean isContainNumber(String c_pw) {
        ...
        for (char c : c_pw.toCharArray()) {
            if (numbers.contains(String.valueOf(c))) return true;
        } return false;
    }
